...
<head>
  ...
  <title>VN TREND</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="assets/img/portfolio/icon-trend.png" rel="icon">
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <h1 class="sitename">VNTREND</h1>
          <span>.</span>
        </a>

        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="./" class="active">Trang Trủ<br></a></li>
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-5 justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2><span>Xu Hướng</span><span class="accent"></span></h2>
            <div class="d-flex">
              <a href="#about" class="btn-get-started">Khám Phá</a>
