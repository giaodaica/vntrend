                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product-title-input" value="" placeholder="Nhập tiêu đề tin" required name="name">

                                    <label class="form-label" for="product-title-input">Giá</label>
                                    <input type="text" class="form-control" id="product-title-input" value="" placeholder="Nhập tiêu đề tin" required name="price">

                                    <label class="form-label" for="product-title-input">Tiêu Đề</label>
                                    <input type="text" class="form-control" id="product-title-input" value="" placeholder="Nhập tiêu đề tin" required name="title">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="manufacturer-name-input" placeholder="Enter manufacturer name" name="slug">
                                                </div>
                                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <select class="form-select" id="choices-category-input" name="categories_id" data-choices data-choices-search-false>
                                   ...
                                   <option value="{{ $render_cate->categories_id }}">{{ $render_cate->categories_name }}</option>
