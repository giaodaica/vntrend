                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="categories_name" id="category-name-input" placeholder="Nhập tên danh mục" required >
                            @isset($error)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="class_filter" id="category-name-input" placeholder="Nhập tên class" required >
                            @isset($error)
